...
namespace _2018_NEA
{
    class Program
    {
        ...
        {
            string name, surname, age, username, filepath, userchoice;
            ...
            if (Duplicate(name, surname, username) != true) 
            {
            ...
            if (Duplicate(name, surname, username) == true)
            {
                Console.WriteLine("Sorry the user already exists");
        ...
        static bool Duplicate(string name, string surname, string username) {
            ...
            {
                string[] fields = lines[i].Split(",");
                if (fields.Contains(name) || fields.Contains(username) || fields.Contains(surname))
                {
                    return true;
                }
            }
